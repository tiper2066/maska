...
import MaskaProgressMember from './MaskaProgressMember';

const FileUploadMemberComponent = () => {
    ...
    const [maxCount] = useState(20); // 마스카 진행 최대 건수
    ...
    return (
        <>
            ...
            {!isValidFiles || selectedFiles.length === 0 ? (
                <div className='file_upload_container memeber relative'>
...
export default FileUploadMemberComponent;
